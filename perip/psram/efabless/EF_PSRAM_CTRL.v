...
module PSRAM_QPI_READER (
    ...
    wire [7:0]  FINAL_COUNT = 14 + size*2; // was 21: Always read 1 word
    ...
    wire[1:0] byte_index = {counter[7:0] - 8'd15}[2:1];
    always @ (posedge clk)
...
module PSRAM_QPI_ENABLER (
    ...
    assign dout     =   (counter < 8) ? {3'b0, CMD_35H[7 - counter]} : 0;
